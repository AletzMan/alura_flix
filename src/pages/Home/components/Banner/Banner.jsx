...
const movie = {
    "adult": false,
    "backdrop_path": "https://image.tmdb.org/t/p/w1280/91qfG6VaxRsCh1SbIi1w2vxknsL.jpg",
    "genre_ids": [
        16,
        35,
        10751
    ...
    "popularity": 233.764,
    "poster_path": "https://image.tmdb.org/t/p/w300/8OTDKkJv2jXg5ZHKazFxBAttKkR.jpg",
    ...
    return (
        <article className={styles.banner}>
            <picture className={styles.banner_picture}>
                ...
                <img className={styles.banner_image} src={movie.backdrop_path} />
            </picture>
            <div className={styles.container}>
                ...
                <picture className={styles.poster}>
                    <img className={styles.poster_image} src={movie.poster_path} />
